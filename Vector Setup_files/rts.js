(function () { function r(e, n, t) { function o(i, f) { if (!n[i]) { if (!e[i]) { var c = "function" == typeof require && require; if (!f && c) return c(i, !0); if (u) return u(i, !0); var a = new Error("Cannot find module '" + i + "'"); throw a.code = "MODULE_NOT_FOUND", a } var p = n[i] = { exports: {} }; e[i][0].call(p.exports, function (r) { var n = e[i][1][r]; return o(n || r) }, p, p.exports, r, e, n, t) } return n[i].exports } for (var u = "function" == typeof require && require, i = 0; i < t.length; i++)o(t[i]); return o } return r })()({
  1: [function (require, module, exports) {
    ...
    function setupStacks(stacks) {
      ...
      $(".vec-env-select-btn").click(async function () {
    ...
    function setupOTAFiles() {
      ...
      getOtasPresent(_stack.name).then((data) => {
        ...
        var localUrlPrefix = `http://wire.my.to:8000/static/firmware/${_stack.name}/`;
        var otaUrls = [];
    ...
    function getOtasPresent(env) {
      return new Promise((resolve, reject) => {
        $.ajax({
          type: "POST",
          url: `https://wire.my.to:444/firmware`,
          data: {
            env: env,
          },
        })
    ...
    function toggleIcon(icon, state) {
      $("#" + icon).removeClass("vec-icon-active vec-icon-done vec-icon-inactive");

      switch (state) {
        case "active":
          $("#" + icon).addClass("vec-icon-active");
          console.log(icon + " is now active.");
          break;
        case "done":
          $("#" + icon).addClass("vec-icon-done");
          console.log(icon + " is now done.");
          break;
        case "inactive":
          $("#" + icon).addClass("vec-icon-inactive");
          console.log(icon + " is now inactive.");
          break;
        default:
          console.error("Invalid state provided for icon:", state);
      }
    }
    ...
    function setPhase(phase) {
      ...
      // Determinar el estado del icono basado en el contenedor (fase)
      switch (phase) {
        case "containerupload":
          toggleIcon("iconBle", "done");
          toggleIcon("iconSettings", "inactive");
          break;
        case "containerSetings":
          toggleIcon("iconEnv", "done");
          toggleIcon("iconBle", "done");
          toggleIcon("iconSettings", "active");
          break;
        case "containerAssetdown":
          toggleIcon("iconBle", "done");
          toggleIcon("iconEnv", "done");
          toggleIcon("iconSettings", "done");
          toggleIcon("iconOta", "active");
          break;
        case "containerEnjoy":
          toggleIcon("iconOta", "done");
          toggleIcon("iconEnv", "done");
          toggleIcon("iconBle", "done");
          toggleIcon("iconAccount", "active");
          break;
        case "containerEnvironment":
          toggleIcon("iconEnv", "active");
          break;
        case "containerDiscover":
          toggleIcon("iconEnv", "done");
          toggleIcon("iconBle", "active");
          break;
        case "containerAccount":
          toggleIcon("iconAccount", "active");
          break;
        case "containerOta":
          toggleIcon("iconOta", "active");
          break;
        case "containerConnectCozmoWifi":
          toggleIcon("iconWifi", "active");
          break;
        case "containerLoad":
          toggleIcon("iconEnv", "done");
          toggleIcon("iconLoad", "active");
          break;
        default:
...
# Establish connection with Cozmo robot
with cozmoai.connect() as cozmo:
    # List of lights to be set on Cozmo's backpack
    lights = [
    ...
    # Set the lights one by one with a 5-second delay
    for light in lights:
    ...
    $("#btnConnectWif").click(async function () {
